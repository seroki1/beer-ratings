...
namespace BeerRatings.Views
{
    public class BeerStylesController : Controller
    {
        ...
        {
            return View(await _context.BeerStyle.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var beerStyle = await _context.BeerStyle
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var beerStyle = await _context.BeerStyle.FindAsync(id);
            if (beerStyle == null)
            {
                return NotFound();
            }
        ...
        {
            var beerStyle = await _context.BeerStyle.FindAsync(id);
            _context.BeerStyle.Remove(beerStyle);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.BeerStyle.Any(e => e.Id == id);
        }
    }
}
